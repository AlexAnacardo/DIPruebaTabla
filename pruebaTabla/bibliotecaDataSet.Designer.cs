...
namespace pruebaTabla {
    ...
    public partial class bibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class LibrosDataTable : global::System.Data.TypedTableBase<LibrosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LibrosRow AddLibrosRow(string Titulo, string ISBN, decimal Precio, int Stock, System.DateTime Fecha, string Genero, string Autor, byte[] Portada) {
            ...
            public System.DateTime Fecha {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Fecha\' de la tabla \'Libros\' es DBNull.", e);
                    }
                }
                set {
...
namespace pruebaTabla.bibliotecaDataSetTableAdapters {
    ...
    public partial class LibrosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Libros] WHERE (([Id] = @Original_Id) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)) AND ((@IsNull_Genero = 1 AND [Genero] IS NULL) OR ([Genero] = @Original_Genero)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Libros] ([Id], [Titulo], [ISBN], [Precio], [Stock], [Fecha], [Genero], [Autor], [Portada]) VALUES (@Id, @Titulo, @ISBN, @Precio, @Stock, @Fecha, @Genero, @Autor, @Portada);
SELECT Id, Titulo, ISBN, Precio, Stock, Fecha, Genero, Autor, Portada FROM Libros WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Libros] SET [Id] = @Id, [Titulo] = @Titulo, [ISBN] = @ISBN, [Precio] = @Precio, [Stock] = @Stock, [Fecha] = @Fecha, [Genero] = @Genero, [Autor] = @Autor, [Portada] = @Portada WHERE (([Id] = @Original_Id) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)) AND ((@IsNull_Fecha = 1 AND [Fecha] IS NULL) OR ([Fecha] = @Original_Fecha)) AND ((@IsNull_Genero = 1 AND [Genero] IS NULL) OR ([Genero] = @Original_Genero)));
SELECT Id, Titulo, ISBN, Precio, Stock, Fecha, Genero, Autor, Portada FROM Libros WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pruebaTabla.Properties.Settings.Default.bibliotecaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Titulo, ISBN, Precio, Stock, Fecha, Genero, Autor, Portada FROM dbo.Li" +
                "bros";
        ...
        public virtual int Delete(int Original_Id, string Original_ISBN, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Stock, global::System.Nullable<global::System.DateTime> Original_Fecha, string Original_Genero) {
        ...
        public virtual int Insert(int Id, string Titulo, string ISBN, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Stock, global::System.Nullable<global::System.DateTime> Fecha, string Genero, string Autor, byte[] Portada) {
            ...
            if ((Autor == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(Autor));
            }
            if ((Portada == null)) {
        ...
        public virtual int Update(int Id, string Titulo, string ISBN, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Stock, global::System.Nullable<global::System.DateTime> Fecha, string Genero, string Autor, byte[] Portada, int Original_Id, string Original_ISBN, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Stock, global::System.Nullable<global::System.DateTime> Original_Fecha, string Original_Genero) {
            ...
            if ((Autor == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Autor));
            }
            if ((Portada == null)) {
        ...
        public virtual int Update(string Titulo, string ISBN, global::System.Nullable<decimal> Precio, global::System.Nullable<int> Stock, global::System.Nullable<global::System.DateTime> Fecha, string Genero, string Autor, byte[] Portada, int Original_Id, string Original_ISBN, global::System.Nullable<decimal> Original_Precio, global::System.Nullable<int> Original_Stock, global::System.Nullable<global::System.DateTime> Original_Fecha, string Original_Genero) {
            return this.Update(Original_Id, Titulo, ISBN, Precio, Stock, Fecha, Genero, Autor, Portada, Original_Id, Original_ISBN, Original_Precio, Original_Stock, Original_Fecha, Original_Genero);
        }
    }
